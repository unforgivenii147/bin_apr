...
class JalaliDate:
    ...
    JALALI_WEEKDAYS_EN = [
        "Shanbeh", "Yekshanbe", "Doshanbe", "Seshanbe", "Chaharshanbe",
        "Panjshanbe", "Jomeh"
    ]
    JALALI_WEEKDAYS_FA = [
    ...
    def __init__(self, jalali_year: int, jalali_month: int,
                 jalali_day: int) -> None:
    ...
    def from_gregorian(g_year: int, g_month: int, g_day: int) -> "JalaliDate":
        ...
        g_day_of_year = (
            ...
            (1 if gm > 1 and
             (g_year % 4 == 0 and g_year % 100 != 0 or g_year % 400 == 0) else
             0))
    ...
    def print_month(self,
        ...
        for week in calendar_grid:
            ...
            for day in week:
                if day == 0:
                    week_str.append("   ")
                elif self.year == today.year and self.month == today.month and (
                        day == today.day):
