...
def extract_embedded_html(text: str) -> str | None:
    """
    Try common SingleFileZ-style wrappers and return decoded standalone HTML.
    """

    # Pattern 1:
    # window.__SINGLEFILE_Z__ = {... "content":"base64..." ...};
    ...
    # Pattern 3:
    # const content = "...."; where it's escaped HTML, not base64
